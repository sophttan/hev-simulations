...
write.csv(results_data, here::here("nila/hev/env-calibration/data/env-results-10.csv"))
write.csv(demg_data, here::here("nila/hev/env-calibration/data/env-demg-10.csv"))
mean(incidence)