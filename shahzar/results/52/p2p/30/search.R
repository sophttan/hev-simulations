...
for (i in 1:d_H) {
    for (j in 1:d_C) {
      ...
      cat(paste0(format(beta_H, nsmall = 1, digits = 3), '/42.0\t', 
                 format(beta_C, nsmall = 3, digits = 3), '/0.130\t'))
      ...
      cat(paste0(format(round(mean(idcs[i, j, ]), 3), nsmall = 3), '\t',
                 format(round(mean(idcs[i, j, idcs[i, j, ] > 0.29 & idcs[i, j, ] < 0.31]), 3), nsmall = 3), '\t',
                 format(round(mean(sars[i, j, ]), 3), nsmall = 3), '\t', 
                 format(round(mean(sars[i, j, idcs[i, j, ] > 0.29 & idcs[i, j, ] < 0.31]), 3), nsmall = 3), '\n'))
