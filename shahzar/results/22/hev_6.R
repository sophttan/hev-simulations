...
for (i in 1:a) {
  for (j in 1:b) {
    ...
    write.table(idcs, file = 'idcs_6.txt', row.names = F, col.names = F)
    write.table(prps, file = 'prps_6.txt', row.names = F, col.names = F)
    cat('\n')
  }
  message('\n')
}