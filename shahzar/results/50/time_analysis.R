...
saveRDS(vals, file = paste0(dir, 'vals_t_05.rds'))
write.table(vals, file = paste0(dir, 'vals_t_05.txt'), row.names = F, col.names = F)
...
vals <- aperm(array(vals, dim = c(365, 2500, 3)), c(2, 1, 3))
saveRDS(vals, file = paste0(dir, 'vals_t_10.rds'))
write.table(vals, file = paste0(dir, 'vals_t_10.txt'), row.names = F, col.names = F)
...
vals <- aperm(array(vals, dim = c(365, 2500, 3)), c(2, 1, 3))
saveRDS(vals, file = paste0(dir, 'vals_t_30.rds'))
write.table(vals, file = paste0(dir, 'vals_t_30.txt'), row.names = F, col.names = F)
