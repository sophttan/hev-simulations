...
while (i <= n_sims) {
    ...
    j <- j + 1
    if (all(metrics(results) > c(0.04, 0.20)) & all(metrics(results) < c(0.06, 0.30))) {
...
while (i <= n_sims) {
    ...
    j <- j + 1
    if (all(metrics(results) > c(0.09, 0.20)) & all(metrics(results) < c(0.11, 0.30))) {
...
while (i <= n_sims) {
    results <- SEIR_pan(params)
    j <- j + 1
    if (all(metrics(results) > c(0.29, 0.20)) & all(metrics(results) < c(0.31, 0.30))) {
...
while (i <= n_sims) {
    results <- SEIR_mix(params)
    j <- j + 1
    if (all(metrics(results) > c(0.04, 0.45)) & all(metrics(results) < c(0.06, 0.55))) {
...
while (i <= n_sims) {
    results <- SEIR_pan(params)
    j <- j + 1
    if (all(metrics(results) > c(0.09, 0.45)) & all(metrics(results) < c(0.11, 0.55))) {
