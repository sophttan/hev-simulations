...
while (i < n_sims) {
    ...
    if (metrics(results) > 0.04 | metrics(results) < 0.06) {
        write.csv(results, file = paste0('pan/5/', i, '.csv'), row.names = F)
        i <- i + 1
    }
}
...
while (i < n_sims) {
    ...
    if (metrics(results) > 0.09 | metrics(results) < 0.11) {
        write.csv(results, file = paste0('pan/10/', i, '.csv'), row.names = F)
        i <- i + 1
    }
}
...
while (i < n_sims) {
    ...
    if (metrics(results) > 0.29 | metrics(results) < 0.31) {
        write.csv(results, file = paste0('pan/30/', i, '.csv'), row.names = F)
        i <- i + 1
    }
}
...
while (i < n_sims) {
    ...
    if (metrics(results) > 0.04 | metrics(results) < 0.06) {
        write.csv(results, file = paste0('0/5/', i, '.csv'), row.names = F)
        i <- i + 1
    }
}
...
while (i < n_sims) {
    results <- SEIR_env(params)
    if (metrics(results) > 0.09 | metrics(results) < 0.11) {
        write.csv(results, file = paste0('0/10/', i, '.csv'), row.names = F)
        i <- i + 1
    }
}
...
while (i < n_sims) {
    results <- SEIR_env(params)
    if (metrics(results) > 0.29 | metrics(results) < 0.31) {
        write.csv(results, file = paste0('0/30/', i, '.csv'), row.names = F)
        i <- i + 1
    }
}
...
while (i < n_sims) {
    ...
    if (metrics(results) > 0.04 | metrics(results) < 0.06) {
        write.csv(results, file = paste0('25/5/', i, '.csv'), row.names = F)
        i <- i + 1
    }
}
...
while (i < n_sims) {
    results <- SEIR_mix(params)
    if (metrics(results) > 0.09 | metrics(results) < 0.11) {
        write.csv(results, file = paste0('25/10/', i, '.csv'), row.names = F)
        i <- i + 1
    }
}
...
while (i < n_sims) {
    results <- SEIR_mix(params)
    if (metrics(results) > 0.29 | metrics(results) < 0.31) {
        write.csv(results, file = paste0('25/30/', i, '.csv'), row.names = F)
        i <- i + 1
    }
}
...
while (i < n_sims) {
    results <- SEIR_mix(params)
    if (metrics(results) > 0.04 | metrics(results) < 0.06) {
        write.csv(results, file = paste0('50/5/', i, '.csv'), row.names = F)
        i <- i + 1
    }
}
...
while (i < n_sims) {
    results <- SEIR_mix(params)
    if (metrics(results) > 0.09 | metrics(results) < 0.11) {
        write.csv(results, file = paste0('50/10/', i, '.csv'), row.names = F)
        i <- i + 1
    }
}
...
while (i < n_sims) {
    ...
    if (metrics(results) > 0.04 | metrics(results) < 0.06) {
        write.csv(results, file = paste0('100/5/', i, '.csv'), row.names = F)
        i <- i + 1
    }
}
...
while (i < n_sims) {
    results <- SEIR_p2p(params)
    if (metrics(results) > 0.09 | metrics(results) < 0.11) {
        write.csv(results, file = paste0('100/10/', i, '.csv'), row.names = F)
        i <- i + 1
    }
}
...
while (i < n_sims) {
    results <- SEIR_p2p(params)
    if (metrics(results) > 0.29 | metrics(results) < 0.31) {
        write.csv(results, file = paste0('100/30/', i, '.csv'), row.names = F)
        i <- i + 1
    }
}