...
params <- c(0.0015, 0.006)
n_sims <- 1000
i <- 0
while (i < n_sims) {
    results <- SEIR(params, inf)
    if (metrics(results) > 10/1000) {
        write.csv(results, file = paste0('30/1/', i, '.csv'), row.names = F)
        i <- i + 1
    }
}

params <- c(0.0014, 0.008)
n_sims <- 1000
i <- 0
while (i < n_sims) {
    results <- SEIR(params, inf)
    if (metrics(results) > 10/1000) {
        write.csv(results, file = paste0('30/2/', i, '.csv'), row.names = F)
        i <- i + 1
    }
}

params <- c(0.0013, 0.012)
n_sims <- 1000
i <- 0
while (i < n_sims) {
    results <- SEIR(params, inf)
    if (metrics(results) > 10/1000) {
        write.csv(results, file = paste0('30/3/', i, '.csv'), row.names = F)
        i <- i + 1
    }
}

params <- c(0.0012, 0.019)
n_sims <- 1000
i <- 0
while (i < n_sims) {
    results <- SEIR(params, inf)
    if (metrics(results) > 10/1000) {
        write.csv(results, file = paste0('30/4/', i, '.csv'), row.names = F)
        i <- i + 1
    }
}

params <- c(0.0011, 0.079)
n_sims <- 1000
i <- 0
while (i < n_sims) {
    results <- SEIR(params, inf)
    if (metrics(results) > 10/1000) {
        write.csv(results, file = paste0('30/5/', i, '.csv'), row.names = F)
        i <- i + 1
    }
}