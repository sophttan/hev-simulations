...
def SEIR(beta_H, beta_C, inc, inf, verbose = 0):
    ...
    for t in range(time):
        ...
        if num_new_exposed > 0:
            ...
            results.loc[new_inf_C == 1, 'TYPE'] = 'C'
            results.loc[new_inf_H == 1, 'TYPE'] = 'H'
            ...
            results.loc[(new_inf_H == 1) & (new_inf_C == 1), 'TYPE'] = 'B'
...
for i in range(a):
    for j in range(b):
        ...
        for k in range(reps):
            ...
            print('{0:0.1f}/{1}'.format(beta_H, 45), '\t', 
