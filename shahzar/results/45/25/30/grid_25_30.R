...
beta_Hs <- seq(11.5, 16.5, 0.2) # 26
beta_Cs <- seq(0.002, 0.012, 0.001) # 11
beta_Es <- seq(0.00070, 0.00090, 0.00001) # 21
...
for (i in 1:d_H) {
  for (j in 1:d_C) {
    for (k in 1:d_E) {
      ...
      cat(paste0(format(beta_H, nsmall = 0), '/16.5\t', 
                 format(beta_C, nsmall = 3), '/0.012\t',
                 format(beta_E, nsmall = 5, scientific = F), '/0.00090\t'))
