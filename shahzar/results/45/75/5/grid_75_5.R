...
beta_Hs <- seq(40.5, 43.5, 0.2) # 16
beta_Cs <- seq(0.025, 0.035, 0.001) # 11
beta_Es <- seq(0.00000, 0.00010, 0.00001) # 11
...
for (i in 1:d_H) {
  for (j in 1:d_C) {
    for (k in 1:d_E) {
      ...
      cat(paste0(format(beta_H, nsmall = 0), '/43.5\t', 
                 format(beta_C, nsmall = 3), '/0.035\t',
