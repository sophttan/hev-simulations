...
beta_Hs <- seq(36, 42, 1) # 11
beta_Cs <- seq(0.045, 0.06, 0.001) # 21
beta_Es <- seq(0.0002, 0.0004, 0.00001) # 21
...
for (i in 1:d_H) {
  for (j in 1:d_C) {
    for (k in 1:d_E) {
      ...
      cat(paste0(format(beta_H, nsmall = 1), '/42\t', 
                 format(beta_C, nsmall = 3), '/0.06\t',
                 format(beta_E, nsmall = 5, scientific = F), '/0.00040\t'))
