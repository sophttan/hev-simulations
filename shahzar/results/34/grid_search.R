...
beta_Hs <- seq(40, 45, 2.5) # 3
beta_Cs <- seq(0, 0.5, 0.025) # 21
beta_Es <- seq(0, 0.0005, 0.00001) # 50
...
for (i in 1:a) {
  for (j in 1:b) {
    for (k in 1:c) {
      ...
      cat(paste0(format(beta_H, nsmall = 1), '/45.0\t', 
                 format(beta_C, nsmall = 3), '/0.500\t',
                 format(beta_E, nsmall = 5, scientific = F), '/0.000050\t'))
