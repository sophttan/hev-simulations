...
p <- inf_type %>% ggplot(aes(month)) + 
  ...
  geom_line(aes(y=has_hh.y, color="75% household transmission")) +
  geom_line(aes(y=has_hh.x.x, color="50% household transmission")) + 
  geom_line(aes(y=has_hh.y.y, color="25% household transmission")) + 
  ...
  labs(title="Comparison of models at 10% cumulative incidence")
